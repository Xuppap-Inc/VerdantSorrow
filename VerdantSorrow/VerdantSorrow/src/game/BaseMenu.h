...
protected: 
	...
	void handleInput(std::vector<Transform*>buttPos, float delay, float &lastUpdate, int &controllerIndex, std::vector<std::string>buttNames,std::vector<Entity*>buttProps, bool isPauseMenu);
	void handleMouseInput(std::vector<Transform*>buttPos, std::vector<Entity*>buttProps);
	void handleControllerInput(float delay, float& lastUpdate, int &controllerIndex, std::vector<std::string>buttNames, std::vector<Entity*>buttProps, bool isPauseMenu);
